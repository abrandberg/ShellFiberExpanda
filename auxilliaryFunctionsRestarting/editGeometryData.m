function filemod = editGeometryData(targetDir,ctrl,fileName)
...
%
%
disp('-----> Removing nodal and element data')
tic

% Read the geometry file from the compression load step
fileID = fopen(horzcat(targetDir,ctrl.fileSep,fileName.geometryFile));
